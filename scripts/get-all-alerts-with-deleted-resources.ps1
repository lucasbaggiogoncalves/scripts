...
if ($rulesWithDeletedResources) {
  
    $rulesWithDeletedResources | Export-Csv -Path "output.csv" -NoTypeInformation
} else {
    Write-Warning "There are no rules with deleted resources."
}
